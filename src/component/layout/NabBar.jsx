...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const fetchSubcategories = async () => {
      try {
        const response = await subcategoryService.getSubcategoriesByCategory(
          hoveredCategory
        );
                    ...
                    categories.map((category) => (
                      ...
                      >
                        <Link
                          ...
                          className={`flex justify-between items-center px-4 py-2 text-sm transition-colors duration-200 ${
                            darkMode
                        ...
                        {hoveredCategory === category._id &&
                          groupedSubcategories[hoveredCategory] && (
                            <div
                              className={`absolute left-full top-0 w-64 rounded-lg shadow-lg ${
                                darkMode
                                  ? "bg-gray-800/90 backdrop-blur-sm"
                                  : "bg-white/90 backdrop-blur-sm"
                              ...
                              <div className="py-1 px-2">
                                ...
                                {groupedSubcategories[
                                  ...
                                  <Link
                                    ...
                                    className={`block px-2 py-1 text-sm rounded transition-colors duration-200 ${
                                      darkMode
                                        ? "hover:bg-gray-700/50 text-gray-300"
                                        : "hover:bg-gray-100/50 text-gray-600"
                                    }`}
