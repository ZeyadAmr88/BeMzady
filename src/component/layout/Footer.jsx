...
const Footer = () => {
    ...
    return (
        <footer className={`${darkMode ? "bg-gradient-to-b from-gray-900 to-gray-800 text-gray-200" : "bg-gradient-to-b from-gray-50 to-white text-gray-700"} pt-10 sm:pt-16 pb-8 sm:pb-12`}>
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
                    {/* About */}
                    <div>
                        <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-rose-600 to-rose-500 bg-clip-text text-transparent">BeMazady</h3>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-6 text-gray-900 dark:text-gray-100">Quick Links</h3>
                    ...
                    {/* Help & Support */}
                    <div>
                        <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-6 text-gray-900 dark:text-gray-100">Help & Support</h3>
                        <ul className="space-y-2 sm:space-y-3">
                            <li>
                                <Link
                                    to="/faq"
                    ...
                    {/* Contact */}
                    <div>
                        <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-6 text-gray-900 dark:text-gray-100">Contact Us</h3>
                        <ul className="space-y-3 sm:space-y-4">
                            <li className="flex items-start">
                                <div className="p-1.5 sm:p-2 rounded-full bg-rose-500/10 text-rose-600 dark:text-rose-400 mr-2 sm:mr-3">
                                    <MapPin size={16} className="sm:w-5 sm:h-5" />
                                </div>
                                <span className="text-gray-500 dark:text-gray-400 text-sm sm:text-base">123 Auction Street, Cairo, Egypt</span>
                            </li>
                            <li className="flex items-center">
                                <div className="p-1.5 sm:p-2 rounded-full bg-rose-500/10 text-rose-600 dark:text-rose-400 mr-2 sm:mr-3">
                                    <Phone size={16} className="sm:w-5 sm:h-5" />
                                </div>
                                <span className="text-gray-500 dark:text-gray-400 text-sm sm:text-base">+20 123 456 7890</span>
                            </li>
                            <li className="flex items-center">
                                <div className="p-1.5 sm:p-2 rounded-full bg-rose-500/10 text-rose-600 dark:text-rose-400 mr-2 sm:mr-3">
                                    <Mail size={16} className="sm:w-5 sm:h-5" />
                                </div>
                                <span className="text-gray-500 dark:text-gray-400 text-sm sm:text-base">info@bemazady.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
