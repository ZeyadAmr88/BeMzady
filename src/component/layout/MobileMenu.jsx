...
import { Search, User, ShoppingCart, Bell, MessageCircle, LogOut, ChevronDown, ChevronRight, LayoutDashboard } from "lucide-react"
        ...
        <form onSubmit={handleSearch} className="mb-4">
          <div className="relative">
            <input
              ...
              className={`w-full py-2 pl-4 pr-10 rounded-full border ${darkMode
